        ...
        <div className="grid grid-cols-6 gap-4">
          ...
          <div className="col-span-2">
            <div className="p-4">
              ...
              <br />
              <div>
                <input type="text" placeholder="Name" className="p-3 border border-gray-400 mb-2" />
              </div>
              <div>
                <input type="text" placeholder="shipping address" className="p-3 border border-gray-400" />
              </div>
              <br />
              <div>
